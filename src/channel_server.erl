%% @author fishballian
%% @doc @todo Add description to channel_server.
...
%% ====================================================================
init([]) ->
	register(world,spawn(fun()-> loop(ets:new(world, [])) end)),
	register(country1,spawn(fun()-> loop(ets:new(country1, [])) end)),
	register(country2,spawn(fun()-> loop(ets:new(country2, [])) end)),
	register(country3,spawn(fun()-> loop(ets:new(country3, [])) end)),
    {ok, #state{}}.
